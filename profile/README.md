...
# cenius.ai — open-source app catalog

**Every repo here is a complete, runnable application — code, design, seeded demo data — generated end-to-end on [cenius.ai](https://cenius.ai) from a plain-English description.**

[🚀 Build your own](https://cenius.ai) · [🛍️ Browse the marketplace](https://cenius.ai/marketplace) · [📚 Showcase index](https://github.com/Cenius-ai/showcase)
...
- [Relay CRM](https://github.com/Cenius-ai/relay-crm-golang) — open-source CRM system in Go · [remix](https://cenius.ai/marketplace/p/relay-crm?ref=gh&utm_campaign=relay-crm-golang)
- [Erlang Contact & Company CRM](https://github.com/Cenius-ai/erlang-contact-company-crm-webapp) — open-source CRM system in Full-stack app · [remix](https://cenius.ai/marketplace/p/erlang-contact-company-crm?ref=gh&utm_campaign=erlang-contact-company-crm-webapp)
- [SimpleZigShortener](https://github.com/Cenius-ai/simplezigshortener-webapp) — open-source web application in Full-stack app · [remix](https://cenius.ai/marketplace/p/simplezigshortener?ref=gh&utm_campaign=simplezigshortener-webapp)
...
- [Harbor](https://github.com/Cenius-ai/harbor-webapp) — open-source blog platform in Full-stack app · [remix](https://cenius.ai/marketplace/p/harbor?ref=gh&utm_campaign=harbor-webapp)
...
- [Aster - Photographer's Social Network](https://github.com/Cenius-ai/aster-photographer-s-social-network-kotlin) — open-source photography social network app in Kotlin/Ktor · [remix](https://cenius.ai/marketplace/p/aster---photographer-s-social-network?ref=gh&utm_campaign=aster-photographer-s-social-network-kotlin)
...
- [wordcount — single-file CLI word counter](https://github.com/Cenius-ai/wordcount-single-file-cli-word-counter-webapp) — open-source command-line tool in Full-stack app · [remix](https://cenius.ai/marketplace/p/wordcount-single-file-cli-word-counter?ref=gh&utm_campaign=wordcount-single-file-cli-word-counter-webapp)
...
_Chat assistants and creative studios (all whitelabel, all yours)._
...
**Have an idea?** Describe it in plain English → get a running, previewable, deployable app.

**[Start building on cenius.ai →](https://cenius.ai)**
